...
def generate_affiliation_link_re(url):
    "overkill"
    pattern = re.compile(r"dp\/[A-Z0-9]+")
    match_obj = pattern.search(url)
    srch_str = match_obj.group(0)    
    return "http://www.amazon.com/" + srch_str + "/?tag=pyb0f-20"

def generate_affiliation_link(url):
    af = url.split("/")[5]
    return "http://www.amazon.com/dp/" + af  + "/?tag=pyb0f-20"
