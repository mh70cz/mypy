...
now_utctz_p   = datetime.datetime.now(tz=pytz.utc) #import pytz ; 3rd party: $ pip install pytz
...
print (f"naive_utc to UTC  {now_naive_utc.astimezone(tz=datetime.timezone.utc)} WRONG, WRONG, WRONG")
