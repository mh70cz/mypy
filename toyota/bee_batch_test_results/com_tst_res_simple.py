...
porovnani vysledku testu v BEE - zjdednodusena verze pouze decision
"""
...
# srcpath_old = Path("C:/BEE_batch/out_wrk_spo")

# srcpath_new = Path("C:/BEE_batch/out__fop")
# srcpath_old = Path("C:/BEE_batch/out_wrk_fop")

srcpath_new = Path("C:/BEE_batch/out__po")
srcpath_old = Path("C:/BEE_batch/out_wrk_po")
...
for file in files_new[:550]:
    ...
    if results_new.decision != results_old.decision:
        results_diffs_cnt += 1
        print (results_new)
        print (results_old)
        print ("")
